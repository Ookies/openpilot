...
DAYS_NO_CONNECTIVITY_MAX = 800  # do not allow to engage after two weeks without internet
DAYS_NO_CONNECTIVITY_PROMPT = 800  # send an offroad prompt after a week with no internet
...
def thermald_thread():
  ...
  while 1:
    ...
    if max_cpu_temp > 107. or bat_temp >= 65. or (has_relay and (started_ts is None) and max_cpu_temp > 70.0):
      # onroad not allowed
